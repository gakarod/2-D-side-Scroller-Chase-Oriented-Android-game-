...
/**
 * Created by Vaibhav Anand on 07-11-2017.
 */
public class StartScreen extends ScreenAdapter {
    ...
    public StartScreen(Game game , com.pointless.mariobros.Tools.Adhandler handler) {
        this.game = game;
    ...
    public void show(){
       ...
       Music background = Gdx.audio.newMusic(Gdx.files.internal("theme.wav"));
        ...
        play.addListener(new ActorGestureListener(){
            public void tap(InputEvent event, float x, float y, int count, int button){
                ...
                game.setScreen(new Instruction(game,handler));
                dispose();
            }
        });
