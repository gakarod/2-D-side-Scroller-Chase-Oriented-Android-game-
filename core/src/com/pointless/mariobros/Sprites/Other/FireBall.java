package com.pointless.mariobros.Sprites.Other;
...
public class FireBall extends Sprite {
    ...
    public FireBall(PlayScreen screen, float x, float y, boolean fireRight){
        ...
        frames.add(new TextureRegion(screen.getAtlas().findRegion("jerry"), 61, 14, 9, 12));
        frames.add(new TextureRegion(screen.getAtlas().findRegion("jerry"), 70, 14, 9, 12));
        frames.add(new TextureRegion(screen.getAtlas().findRegion("jerry"), 79, 14, 9, 12));
        frames.add(new TextureRegion(screen.getAtlas().findRegion("jerry"), 88, 14, 9, 12));
